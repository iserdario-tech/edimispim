...
export interface StoredState {
  ...
  cheatDays?: string[];
  /**
   * Замены блюд: дата → приём → id рецепта.
   *
   * Без этого замена жила только в памяти вкладки: человек менял ужин, обновлял
   * страницу — и возвращалось прежнее блюдо. Хранится по дате, потому что меню теперь
